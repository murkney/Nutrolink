...
export default async function supplementList() {
	...
	const query = `*[_type == 'product'] | order(title asc) {
		...
		"category": reference.title.supplements,
		price,
		description
  	}`;
	...
	function createSupplementsContainerDOM() {
		for (const product of products) {
			const productContainer = document.getElementById('supplements-container');
